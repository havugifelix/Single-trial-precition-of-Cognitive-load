...
batch_size =32
train_data_dir ="/media/kashraf/Elements/Dissertation/data/preprocessed/visual/topomaps/theta/training"
validation_data_dir = "/media/kashraf/Elements/Dissertation/data/preprocessed/visual/topomaps/theta/validation"
...
def build_and_train(hype_space, save_best_weights=False, log_for_tensorboard=False):
  ...
  #####   
    ...
    WEIGHTS_DIR="/media/kashraf/Elements/Dissertation/modelling/model_weights/"
    if save_best_weights:
        weights_save_path = os.path.join(
            WEIGHTS_DIR, '{}_Theta_single_trial_v1.h5'.format(model_uuid))
